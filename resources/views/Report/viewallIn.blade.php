                      ...
                      @else
                        ...
                        @foreach($details as $detail)
                            ...
                            <tr>
                                ...
                                <td> <a href="{{url('order-items')}}/{{$detail->orderNo}}" target="_blank" data-toggle="tooltip" data-placement="bootom" title="Edit record"><button class="btn btn-outline-success"><i class="fa fa-eye"></i></button></a> </td>
                            </tr>
                        @endforeach
