    ...
    <ul id="sidebar_menu">
        ...
        <li class="">
            ...
            <ul>
              ...
              <li><a href="{{ Route::has('createProductMovement') ? Route('createProductMovement') : 'javascript:;'  }}"> Product Entry </a></li>
              <li><a href="{{ Route::has('createProductGoingOut') ? Route('createProductGoingOut') : 'javascript:;'  }}"> Product Moving Out </a></li>
