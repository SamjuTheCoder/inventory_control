...
<nav aria-label="breadcrumb" class="">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{route('display-confirm-in')}}">Transactions-in</a></li>
                            ...
                            <div class="QA_section">
                                <div class="QA_table mb-0 transaction-table">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table lms_table_active2 " id="tblCheck">
                                                ...
                                                @foreach($orders as $key => $list)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$list->move_in}} [ <span style="color:green">{{ $list->formatqty}}</span>] </td>
                                                        <td>
